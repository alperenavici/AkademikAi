    ...
    public partial class initialcreate2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), false, "A", 1, "Kuvvet = Kütle × Hız", new Guid("11111111-7777-7777-7777-777777777777") },
                    { new Guid("11111111-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), true, "B", 2, "Kuvvet = Kütle × İvme", new Guid("11111111-7777-7777-7777-777777777777") },
                    { new Guid("11111111-cccc-cccc-cccc-cccccccccccc"), false, "C", 3, "Kuvvet = Kütle × Zaman", new Guid("11111111-7777-7777-7777-777777777777") },
                    { new Guid("11111111-dddd-dddd-dddd-dddddddddddd"), false, "D", 4, "Kuvvet = Kütle × Mesafe", new Guid("11111111-7777-7777-7777-777777777777") },
                    { new Guid("22222222-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), false, "A", 1, "m × v", new Guid("22222222-8888-8888-8888-888888888888") },
                    { new Guid("22222222-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), true, "B", 2, "1/2 × m × v²", new Guid("22222222-8888-8888-8888-888888888888") },
                    { new Guid("22222222-cccc-cccc-cccc-cccccccccccc"), false, "C", 3, "m × v²", new Guid("22222222-8888-8888-8888-888888888888") },
                    { new Guid("22222222-dddd-dddd-dddd-dddddddddddd"), false, "D", 4, "2 × m × v", new Guid("22222222-8888-8888-8888-888888888888") },
                    { new Guid("33333333-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), false, "A", 1, "CO₂", new Guid("33333333-9999-9999-9999-999999999999") },
                    { new Guid("33333333-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), true, "B", 2, "H₂O", new Guid("33333333-9999-9999-9999-999999999999") },
                    { new Guid("33333333-cccc-cccc-cccc-cccccccccccc"), false, "C", 3, "O₂", new Guid("33333333-9999-9999-9999-999999999999") },
                    { new Guid("33333333-dddd-dddd-dddd-dddddddddddd"), false, "D", 4, "N₂", new Guid("33333333-9999-9999-9999-999999999999") },
                    { new Guid("44444444-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), false, "A", 1, "Bazik", new Guid("44444444-aaaa-aaaa-aaaa-aaaaaaaaaaaa") },
                    { new Guid("44444444-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), true, "B", 2, "Asidik", new Guid("44444444-aaaa-aaaa-aaaa-aaaaaaaaaaaa") },
                    { new Guid("44444444-cccc-cccc-cccc-cccccccccccc"), false, "C", 3, "Nötr", new Guid("44444444-aaaa-aaaa-aaaa-aaaaaaaaaaaa") },
                    { new Guid("44444444-dddd-dddd-dddd-dddddddddddd"), false, "D", 4, "Amfoter", new Guid("44444444-aaaa-aaaa-aaaa-aaaaaaaaaaaa") },
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), false, "A", 1, "3", new Guid("aaaaaaaa-1111-1111-1111-111111111111") },
                    { new Guid("aaaaaaaa-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), true, "B", 2, "4", new Guid("aaaaaaaa-1111-1111-1111-111111111111") },
                    { new Guid("aaaaaaaa-cccc-cccc-cccc-cccccccccccc"), false, "C", 3, "5", new Guid("aaaaaaaa-1111-1111-1111-111111111111") },
                    { new Guid("aaaaaaaa-dddd-dddd-dddd-dddddddddddd"), false, "D", 4, "6", new Guid("aaaaaaaa-1111-1111-1111-111111111111") },
